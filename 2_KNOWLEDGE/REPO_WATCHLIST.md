...
| [ant-design/ant-design](https://github.com/ant-design/ant-design) | design | A | 75 | React UI library; Enterprise design system; Components; | ✅ **REFERENCE→craft-MINED** (corrected) — runtime N/A but CSS/token patterns adopted: layered-shadows + tabular-nums + pill-badge → native_composer (frame-verified) |
