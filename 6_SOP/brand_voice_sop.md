# SOP: Brand Voice Guidelines

## SEOSONA (Business)

### Tone
- Professional, authoritative, confident
- Uses industry terminology with clear explanations
...
- Speaks like a friend, relaxed and casual
...
1. **100% Vietnamese** in video content — English terms must be explained
...
5. **Quality Gate:** All scripts are evaluated by the `EVALUATE_NODE` (`4_BRAIN/quality_scorer.py`). Scripts that violate Brand Tone or Vocabulary rules will trigger the `OODA Loop` to reject and auto-rewrite the content.
