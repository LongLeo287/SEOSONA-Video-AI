...
| 6 | **BUILD (native)** | Implement SEOSONA-native (reuse-first; extend, don't fork). Don't vendor anything that conflicts with `native_composer`/engines | `6_SOP/REPO_VETTING_SOP.md` step 4 (dedup) |
